...
<div id="carouselExampleCaptions" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="Images/hop.jpeg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="Images/rond-point.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>BIYEM-ASSI</h5>
        <p>BIYEM-ASSI</p>
      </div>
...
<div class="container">
    <div class="row">
        <div class="col">
            <p>
                Bienvenue    sur le site Web du quartier BIYEM-ASSI!
                    Vous êtes à la bonne porte pour découvrir ce quartier dans toute sa beauté et son éclat!.Il est situé
                en plein coeur de la ville de Yaoundé plus précisement dans le 6ème arrondissement.
            </p>
        </div>
        ...
        <div class="trad" >
    <button style="background-color:aqua"><a href="index2.php" style="color:black">Anglais</a></button>
</div>
