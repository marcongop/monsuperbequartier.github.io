...
<div id="confirmation-message" class="confirmation-message">Your registration has been recorded! Thank you.</div>

<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>

<div class="trad" >
    <button style="background-color:aqua"><a href="inscription.php" style="color:black">Français</a></button>
</div>
